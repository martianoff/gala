...
| Project | Description |
|---------|-------------|
| [GALA Playground](https://github.com/martianoff/gala-playground) | Web-based playground (like go.dev/play) -- write and run GALA code in the browser with 9 built-in examples |
