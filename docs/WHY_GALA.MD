...
GALA delivers these things by transpiling to clean, readable Go code. The output is not obfuscated -- it is Go you could have written yourself, just with more discipline enforced at the source level.
