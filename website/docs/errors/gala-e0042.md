---
layout: default
title: "GALA-E0042 — Lambda Parameter Is Not Parenthesized"
description: "\"lambda parameters must be parenthesized\" — GALA-E0042 fires on `x => e`, the bare single-parameter lambda Scala, Kotlin and JS accept. See the real compiler output, the fix, and why the grammar is not relaxed to admit it."
keywords: "gala-e0042, gala lambda syntax, gala lambda parentheses, gala arrow function, gala single parameter lambda, gala x => y, gala anonymous function"
permalink: /docs/errors/gala-e0042/
last_modified_at: 2026-08-30
---

<p class="breadcrumb"><a href="/">Home</a> / <a href="/docs/">Docs</a> / <a href="/docs/errors/">Error Codes</a> / GALA-E0042</p>
